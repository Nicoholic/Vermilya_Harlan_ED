...
#define UE_PROJECT_NAME Vermilya_Harlan_ED
#define UE_TARGET_NAME Vermilya_Harlan_EDEditor
#define UE_MODULE_NAME "Vermilya_Harlan_ED"
...
#define VERMILYA_HARLAN_ED_API DLLEXPORT
